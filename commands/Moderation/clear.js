const Discord = require('discord.js'); // used for message embeds, etc
  ...
  module.exports = {
      ...
      async execute(message, args, bot, config){
        ...
        if (!config.devs.includes(message.author.id.toString())||message.member.hasPermission("MANAGE_MESSAGES")){return message.reply("Only my owners can use this command")}
        const value = args[0]
